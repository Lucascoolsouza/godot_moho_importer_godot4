...
var _image_sequence_importer_plugin : EditorPlugin
var _helpers_in_use := []
...
func _enter_tree():
	print("MohoImporter entering tree")
...
func _exit_tree():
	print("MohoImporter exiting tree")
	if _moho_importer:
	...
	# Remove image sequence importer plugin
	if _image_sequence_importer_plugin:
		_image_sequence_importer_plugin._exit_tree()
		remove_child(_image_sequence_importer_plugin)
		_image_sequence_importer_plugin = null
